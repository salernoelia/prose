...
// Prose vendors foliate-js for ePub only; PDF is rendered by pdfjs-dist behind
// its own BookRenderer. The comic-book/fb2/mobi/pdf branches were removed so
// their modules (and foliate's bundled pdfjs) need not ship.
